    ...
    <View style={styles.container}>
     <TouchableOpacity style={styles.buttonicon} onPress={() => navigation.goBack()}>
      ...
      <View style={styles.container2}>
        <Text style={styles.title}>Qual é o tipo do seu contato de emergência?</Text>

        <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('usucomum')}> 
          <Text style={styles.buttonText}>Contato Comum</Text>
        </TouchableOpacity>


        <TouchableOpacity style={styles.button2} onPress={() => navigation.navigate('usuLipas')}> 
          <Text style={styles.buttonText}>Contato Lipa’s</Text>
        </TouchableOpacity>

        <View style={styles.info}>
          <Text style={styles.infoText}>
            • <Text style={styles.bold}>Contato Comum:</Text> É a pessoa que não tem cadastro em nosso aplicativo.
          </Text>
          <Text style={styles.infoText}>
            • <Text style={styles.bold}>Contato Lipa’s:</Text> É a pessoa que tem o cadastro em nosso aplicativo.
          </Text>
        </View>
      </View>
    </View>
