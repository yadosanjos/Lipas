...
const FirstRoute = () => (
  <ScrollView style={{ flex: 1, backgroundColor: '#FFEDE3' }} >
    <Text style={styles.titulotopico}>1. Aceitação dos Termos</Text>
      ...
      <Text style={styles.texto}>•Botão de Pânico: Permite que você envie alertas de emergência para contatos predefinidos.</Text>{'\n'}
      <Text style={styles.texto}>•Geolocalização em Tempo Real: Rastreia sua localização para fornecer assistência em caso de necessidade.</Text>{'\n'}
      <Text style={styles.texto}>•Manual de Defesa: Fornece informações sobre autodefesa e segurança pessoal.</Text>{'\n'}
      <Text style={styles.texto}>•Contatos de Emergência: Armazena informações de contato para uso em situações de emergência.</Text>
</Text>
...
const SecondRoute = () => (
  <ScrollView style={{ flex: 1, backgroundColor: '#FFEDE3' }} >
        <Text style={styles.subtitulo}>Política de Privavidade do Aplicativo Lipa´s</Text>
      ...
      <Text style={styles.texto}>- O aplicativo “Lipa’s” coleta informações como nome, endereço de e-mail, número de telefone e localização.{'\n'}
      <Text style={styles.texto}>- Esses dados são usados para fornecer os serviços do aplicativo, como o botão de pânico e a geolocalização em tempo real.
        </Text>
        </Text>
      ...
      <Text style={styles.texto}>- Contatos de Emergência: Armazena informações de contato para uso em situações de emergência.</Text>
        ...
        <Text style={styles.titulotopico}>8. Alteração nas políticas de prvacidade</Text>
        <Text style={styles.texto}>
        ...
        <Text style={styles.texto}>Ao utilizar o aplicativo "Lipa’s", você concorda com a coleta, uso e compartilhamento de suas informações pessoais conforme descrito nesta Política de Privacidade.
        </Text>
        </Text>
        <View style={styles.combo}>
       </View>
